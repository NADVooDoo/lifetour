...
var _initHeroSwiper = require("./modules/hero/init-hero-swiper");
var _getHeight = require("./modules/hero/get-height");
var _video = require("./modules/hero/video");
var _audio = require("./modules/hero/audio");
var _initToursSwiper = require("./modules/init-tours-swiper");
var _isMobileDevice = require("./utils/is-mobile-device");
var _initCoachingSwiper = require("./modules/init-coaching-swiper");
var _initReviewsSwiper = require("./modules/init-reviews-swiper");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _isMobileDevice.isMobileDevice)();
  (0, _getHeight.getHeight)();
  var burger = new _burger.Burger();
  burger.init();
  (0, _initHeroSwiper.getHeroSlider)();
  (0, _initReviewsSwiper.getReviewsSlider)();
  (0, _initAdvantagesSwiper.getAdvantagesSlider)();
  ...
  window.addEventListener('load', function () {
    (0, _video.initVideo)();
    (0, _audio.initAudio)();
    (0, _initToursSwiper.getToursSlider)();
    (0, _initCoachingSwiper.getCoachingSlider)();
...
},{"../../utils/focus-lock":20,"../../utils/scroll-lock":25}],3:[function(require,module,exports){
"use strict";
...
var initAudio = function initAudio() {
  if (document.querySelector('[data-audio]')) {
    var root = document.querySelector('[data-audio]');
    var button = root.querySelector('[data-audio-control]');
...
var getHeroSlider = function getHeroSlider() {
  var sliderElement = document.querySelector('[data-hero-slider]');
  if (!sliderElement) {
    return null;
  }
  var listElement = sliderElement.querySelector('[data-hero-list]');
  ...
  document.addEventListener('keydown', function (event) {
    ...
    setTimeout(function () {
      var slideElement = document.activeElement.closest('[data-hero-slide]');
      if (!slideElement) {
        return;
      }
      var _slideElement$getBoun = slideElement.getBoundingClientRect(),
        left = _slideElement$getBoun.left;
      if (left) {
        var index = parseInt(slideElement.dataset.heroSlide, 10);
        slider.slideTo(index);
        var _getComputedStyle$tra = getComputedStyle(listElement).transform.match(/([-\d]+?),\s0\)$/),
          _getComputedStyle$tra2 = _slicedToArray(_getComputedStyle$tra, 2),
          currentTransform = _getComputedStyle$tra2[1];
        listElement.style.transform = "translate3d(".concat(parseInt(currentTransform, 10) - left, "px, 0, 0)");
      }
    }, 33);
  });
  return slider;
...
},{"../../utils/is-mobile-device":23,"../../vendor/swiper":27}],13:[function(require,module,exports){
"use strict";
...
var initVideo = function initVideo() {
  ...
  if (video) {
    var player = video.querySelector('[data-player]');
    var button = video.querySelector('[data-control]');
    (0, _loadScript.loadScript)('https://youtube.com/player_api', function () {
      window.onYouTubePlayerAPIReady = function () {
        var youtubePlayer = new window.YT.Player(player, {
          width: '100%',
          height: '100%',
          events: {
...
},{"../../utils/load-script.js":24}],14:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getAdvantagesSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
var _isMobileDevice = require("../utils/is-mobile-device");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var createSlider = function createSlider() {
  if (document.querySelector('[data-advantages-slider]')) {
    return new _swiper.default('[data-advantages-slider]', {
...
var getAdvantagesSlider = function getAdvantagesSlider() {
  var swiper = null;
...
exports.getAdvantagesSlider = getAdvantagesSlider;

},{"../utils/is-mobile-device":23,"../vendor/swiper":27}],15:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getCoachingSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
var _isMobileDevice = require("../utils/is-mobile-device");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var getCoachingSlider = function getCoachingSlider() {
  if (document.querySelector('[data-coaching-slider]')) {
    return new _swiper.default('[data-coaching-slider]', {
      direction: 'horizontal',
      allowTouchMove: (0, _isMobileDevice.isMobileDevice)(),
      spaceBetween: 30,
      breakpoints: {
...
exports.getCoachingSlider = getCoachingSlider;

},{"../utils/is-mobile-device":23,"../vendor/swiper":27}],16:[function(require,module,exports){
"use strict";
...
var _isMobileDevice = require("../utils/is-mobile-device");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var getGallerySlider = function getGallerySlider() {
...
exports.getGallerySlider = getGallerySlider;

},{"../utils/is-mobile-device":23,"../vendor/swiper":27}],17:[function(require,module,exports){
"use strict";
...
var getReviewsSlider = function getReviewsSlider() {
  if (document.querySelector('[data-reviews-slider]')) {
    return new _swiper.default('[data-reviews-slider]', {
      direction: 'horizontal',
      allowTouchMove: (0, _isMobileDevice.isMobileDevice)(),
      slidesPerView: 'auto',
      spaceBetween: 30,
...
},{"../utils/is-mobile-device":23,"../vendor/swiper":27}],18:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getToursSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
var _isMobileDevice = require("../utils/is-mobile-device");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var getToursSlider = function getToursSlider() {
  if (document.querySelector('[data-tours-slider]')) {
    return new _swiper.default('[data-tours-slider]', {
      allowTouchMove: (0, _isMobileDevice.isMobileDevice)(),
      direction: 'horizontal',
      breakpoints: {
        0: {
...
exports.getToursSlider = getToursSlider;

},{"../utils/is-mobile-device":23,"../vendor/swiper":27}],19:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":21}],26:[function(require,module,exports){
"use strict";
